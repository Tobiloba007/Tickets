...
const AdminSupportTable = ({ setOpenModal }) => {
    ...
    <div className="flex flex-col items-center justify-start w-full mt-3 mb-6 md:mt-2 lg:mt-3 xl:mt-4 xl:mb-8">
      <div className="flex items-center justify-center w-full md:mt-2">
        <div className="flex items-center justify-between px-5 bg-white h-14 rounded-t-2xl w-full mt-5 pt-2 border-b-[1px] border-[#dddddd] md:mt-2 xl:px-8 xl:h-16">
          <p className="text-sm text-[#571845] font-medium xl:text-lg"></p>
          <div className="flex items-center">
            <MdFilterList className="text-[#292D32] w-6 md:w-7 xl:text-xl" />
            <p className="text-[10px] text-[#292D32] font-medium md:pl-1 md:text-[11px] xl:text-[13px]">
              Filter  Sort{" "}
            </p>
          </div>
        </div>
          ...
          <thead className="bg-[#F6F5F6]">
            <tr className="w-full rounded-lg">
              <th className="px-4 py-[10px] bg-[#F6F5F6] text-[11px] font-medium text-start text-[#766871] md:py-3 lg:py-3 xl:px-8 xl:py-4 xl:text-[13px]">
                <p className="w-[150px]">USER ID</p>
              </th>
              <th className="px-4 py-[10px] bg-[#F6F5F6] text-[11px] font-medium text-start text-[#766871] md:py-3 lg:py-3 xl:px-8 xl:py-4 xl:text-[13px]">
                <p className="w-[75px] md:w-[90px]">TICKET ID</p>
              </th>
              <th className="px-4 py-[10px] bg-[#F6F5F6] text-[11px] font-medium text-start text-[#766871] md:py-3 lg:py-3 xl:px-8 xl:py-4 xl:text-[13px]">
                <p className="w-[75px] md:w-[90px]">DISPUTE TYPE</p>
              </th>
              <th className="px-4 py-[10px] bg-[#F6F5F6] text-[11px] font-medium text-start text-[#766871] md:py-3 lg:py-3 xl:px-8 xl:py-4 xl:text-[13px]">
                <p className="w-[75px] md:w-[90px]">DATE OF ISSUE</p>
              </th>
              <th className="px-4 py-[10px] bg-[#F6F5F6] text-[11px] font-medium text-start text-[#766871] md:py-3 lg:py-3 xl:px-8 xl:py-4 xl:text-[13px]">
                <p className="w-[75px] md:w-[90px]">STATUS</p>
              </th>
            </tr>
          </thead>
                ...
                <tr className="w-full bg-white hover:bg-[#F6F5F6]">
                  <td className="px-4 py-3 border-t-[1px] border-[#E1DEE0] text-xs font-medium md:py-4 lg:py-5 xl:px-8 xl:py-6 xl:text-sm">
                    <div className="flex items-center justify-start">
                      ...
                      <p className="w-full pl-2 text-[#571845] xl:text-sm xl:pl-3">
                        {item?.id}
                      </p>
                    </div>
                  </td>
                  ...
                  <td className="relative px-4 py-3 border-t-[1px] border-[#E1DEE0] text-xs font-medium  md:py-4 lg:py-5 xl:px-8 xl:py-6 xl:text-sm">
                    <div
                      // onClick={() => handleOpen(item)}
                      className="flex items-center justify-center cursor-pointer w-[5.7rem] h-10  rounded-xl bg-neutral-200  hover:bg-[#9e9d9b] transition-all"
                    >
                      <p className=" text-[#FFC655] hover:text-white text-center xl:text-sm xl:pr-3">
                        Open
                      </p>
                        ...
                        {actions.map((action) => {
                          return (
                            <div
                              ...
                              className={`flex flex-col items-start w-full border-b-[1px] border-[#dddddd] p-3 ${
                                item === "Delete" && "border-none"
                              }`}
                            >
                              <p className="pl-2 text-[#571845] text-[11px] xl:text-[13px]">
                                {action}
                              </p>
                            </div>
                          );
