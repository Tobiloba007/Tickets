...
const EventsCategory: React.FC = () => {
  ...
  return (
    <div className='flex-col items-center justify-center w-full px-6 py-10 bg-[#ffffff] md:px-8 md:py-14 lg:py-12 lg:px-10 xl:px-16'>
        ...
        <div className='flex flex-row items-center justify-start w-full mt-7 md:mt-12 lg:mt-16 xl:mt-20'>
