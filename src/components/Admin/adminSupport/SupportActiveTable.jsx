                ...
                <tbody>
                  <tr className='w-full bg-white hover:bg-[#F6F5F6]'>
                    ...
                    <td className="px-4 py-3 border-t-[1px] border-[#E1DEE0] text-xs font-medium text-[#331F2D] md:py-4 lg:py-5 xl:px-8 xl:py-6 xl:text-sm">
                       <div className={`flex items-center justify-center h-7 w-full rounded-2xl xl:h-8 bg-[#FFF9EE]`}>
                              <p className={`xl:text-sm text-[#FFC655]`}>
                                  {item.status}
                              </p>
                         </div>
                    </td>
...
export default SupportActiveTable
