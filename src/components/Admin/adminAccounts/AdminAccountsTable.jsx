...
const AdminAccountsTable = ({setOpenModal}) => {
    const [open, setOpen] = useState(false);
    const [select, setSelected] = useState('');

    const actions = ['Activate', 'Deactivate', 'Reset Password']
       ...
       <div className="overflow-x-auto w-full hide-scrollbar pb-[150px]">
                ...
                <tbody>
                  <tr className='w-full bg-white hover:bg-[#F6F5F6]'>
                    ...
                    <td className="px-4 py-3 border-t-[1px] border-[#E1DEE0] text-xs font-medium text-[#331F2D] md:py-4 lg:py-5 xl:px-8 xl:py-6 xl:text-sm">{item.role}</td>
                    <td className="px-4 py-3 border-t-[1px] border-[#E1DEE0] text-xs font-medium text-[#331F2D] md:py-4 lg:py-5 xl:px-8 xl:py-6 xl:text-sm">{item.dateCreated}</td>
                    <td className="px-4 py-3 border-t-[1px] border-[#E1DEE0] text-xs font-medium text-[#331F2D] md:py-4 lg:py-5 xl:px-8 xl:py-6 xl:text-sm">{item.lastSeen}</td>
                         ...
                         <div className='absolute left-1 mt-[6px] flex flex-col items-start border-[1px] border-[#dddddd] rounded bg-white z-50 w-[90px] md:w-[106px] lg:w-[111px] xl:w-[157px]'>
                              {actions.map((action) => {
                                return(
                                    ...
                                    className={`flex flex-col items-start w-full cursor-pointer border-b-[1px] border-[#dddddd] p-3 ${item === 'Delete' && 'border-none'}`}>
