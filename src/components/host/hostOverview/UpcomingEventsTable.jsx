...
const UpcomingEventsTable = () => {
  return (
    <div className='flex flex-col items-center justify-start w-full bg-[#FAFAFA] mt-4 mb-2 md:mt-0 md:w-[49%]'>
         <div className='w-full px-5 md:px-0 md:pr-5 lg:pr-6 xl:pr-8'>
         ...
         <div className="overflow-x-auto w-full hide-scrollbar px-5 md:px-0 md:pr-5 lg:pr-6 xl:pr-8">
            <table className="table-auto border-collapse w-full rounded-lg border-[1px] border-[#00000]">
              <thead className='bg-[#F6F5F6]'>
                <tr className='w-full rounded-lg'>
                  ...
                  <th className="px-4 py-[10px] bg-[#F6F5F6] text-xs font-medium text-start text-[#4F3D49] md:py-3 lg:py-3 xl:px-5 xl:py-4 xl:text-sm">
                    <p className='w-[75px] md:w-[60px] xl:w-[100px]'>
                         Date
                    </p>
                  </th>
                  <th className="px-4 py-[10px] bg-[#F6F5F6] text-xs font-medium text-start text-[#4F3D49] md:py-3 lg:py-3 xl:px-5 xl:py-4 xl:text-sm">
              ...
              <tbody>
                <tr className='w-full bg-white hover:bg-[#F6F5F6]'>
                  ...
                  <td className="px-4 py-3 border-t-[1px] border-[#E1DEE0] text-xs font-medium md:py-4 lg:py-5 xl:px-8 xl:py-6 xl:text-sm">10-03-2022</td>
                  <td className="px-4 py-3 border-t-[1px] border-[#E1DEE0] text-xs font-medium text-[#1A0313] md:py-4 lg:py-5 xl:px-8 xl:py-6 xl:text-sm">500, 523</td>
                </tr>
                ...
                <tr className='w-full bg-white hover:bg-[#F6F5F6]'>
                  ...
                  <td className="px-4 py-3 border-t-[1px] border-[#E1DEE0] text-xs font-medium md:py-4 lg:py-5 xl:px-8 xl:py-6 xl:text-sm">10-03-2022</td>
                  <td className="px-4 py-3 border-t-[1px] border-[#E1DEE0] text-xs font-medium text-[#1A0313] md:py-4 lg:py-5 xl:px-8 xl:py-6 xl:text-sm">5500, 523</td>
                </tr>
